...
> **Status**: `deferred`
> **Deferred Reason**: Superseded by DISC-011 (Unified Artifact Model). The "Policy" concept is handled by tier-skip mechanism with `skipped_tiers: ["spec"]`. Orphan ADRs are addressed by Primary Chain validation.
> **Created**: 2025-12-31
> **Updated**: 2025-12-31
> **Author**: Cascade AI
