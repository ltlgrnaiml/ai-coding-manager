...
Per ADR-0001: AI Development Workflow Orchestration.
...
class OpenQuestion(BaseModel):
    ...
    status: QuestionStatus = Field(default=QuestionStatus.OPEN, description="Current status")
...
class DecisionPoint(BaseModel):
    ...
    status: DecisionStatus = Field(default=DecisionStatus.PENDING, description="Current status")
...
class DiscussionSchema(BaseModel):
    ...
    schema_type: Literal["discussion"] = Field(default="discussion", description="Schema type")
    ...
    status: DiscussionStatus = Field(default=DiscussionStatus.DRAFT, description="Current status")
    ...
    # Summary
    summary: str = Field(..., description="One paragraph describing what this discussion is about")
    ...
    # Requirements
    requirements: DiscussionRequirements | None = Field(None, description="Captured requirements")
    ...
    recommendation: str | None = Field(None, description="Recommended option and why")
