...
Example:
    from ai_dev_orchestrator.llm import create_rag_chain
...
from ai_dev_orchestrator.llm.xai_langchain import get_xai_chat_model
...
RAG_PROMPT_TEMPLATE = """You are a helpful assistant with access to a project knowledge archive.
...
class RAGChain:
    ...
    def __init__(
        ...
        Args:
            ...
            sanitizer: Custom sanitizer function.
    ...
    def _get_retriever(self):
        ...
        try:
            from ai_dev_orchestrator.knowledge import get_context_builder
