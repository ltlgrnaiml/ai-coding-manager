...
def rerank_with_llm(
    ...
    try:
        from ai_dev_orchestrator.llm.service import is_available, generate_structured
...
class EnhancedRAGConfig:
    ...
    Attributes:
        use_query_enhancement: Enable Level 1 query enhancement.
        use_llm_reranking: Enable Level 2 LLM re-ranking.
        use_graph_expansion: Enable Level 3 graph expansion.
        max_candidates: Initial retrieval count.
        top_k: Final context count.
        max_tokens: Token budget for context.
        graph_hops: Relationship hops for graph expansion.
    """
...
class EnhancedRAGResult:
    ...
    Attributes:
        ...
        query_used: The enhanced query that was used.
        reranked: Whether LLM re-ranking was applied.
        graph_expanded: Whether graph expansion was applied.
...
class EnhancedRAGBuilder:
    ...
    def __init__(self, config: EnhancedRAGConfig | None = None):
        """Initialize enhanced RAG builder.
